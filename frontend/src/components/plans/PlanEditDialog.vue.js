...
const __VLS_36 = __VLS_asFunctionalComponent1(__VLS_35, new __VLS_35({
    modelValue: (__VLS_ctx.form.targetUnknown),
...
if (!__VLS_ctx.form.targetUnknown) {
    let __VLS_40;
    /** @ts-ignore @type { | typeof __VLS_components.vTextField | typeof __VLS_components.VTextField | typeof __VLS_components['v-text-field']} */
    vTextField;
    // @ts-ignore
    const __VLS_41 = __VLS_asFunctionalComponent1(__VLS_40, new __VLS_40({
        modelValue: (__VLS_ctx.form.targetAmount),
        variant: "outlined",
        label: "Target Amount (₦)",
        type: "number",
        density: "comfortable",
...
// @ts-ignore
[open, open, form, form, form, form, form, form, form, form, required, statusOptions,];
var __VLS_20;
let __VLS_60;
