...
const AddIncomeDialog = shallowRef(null);
...
const filteredIncomes = computed(() => {
    ...
    return incomeStore.incomes.filter((income) => {
        if (searchFilter.value === "Sender")
            return income.sender.toLowerCase().includes(q);
        if (searchFilter.value === "Purpose")
            return income.purpose?.toLowerCase().includes(q);
        if (searchFilter.value === "Amount")
            return String(income.amount).includes(q);
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ref: "listContainer",
    ...{ class: "overflow-y-auto flex-grow-1 bg-bluegrey" },
});
/** @type {__VLS_StyleScopedClasses['overflow-y-auto']} */ ;
/** @type {__VLS_StyleScopedClasses['flex-grow-1']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-bluegrey']} */ ;
for (const [group, date] of __VLS_vFor((__VLS_ctx.groupedIncomes))) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        key: (date),
        ...{ class: "mb-4" },
    });
    /** @type {__VLS_StyleScopedClasses['mb-4']} */ ;
    for (const [income] of __VLS_vFor((group))) {
        const __VLS_29 = IncomeItem;
        // @ts-ignore
        ...
        var __VLS_33;
        // @ts-ignore
        [filters, handleSearch, incomeStore, load, groupedIncomes, openEdit, openDuplicate, confirmDelete,];
    }
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
if (!__VLS_ctx.incomeStore.isLoading && __VLS_ctx.filteredIncomes.length === 0) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
const __VLS_63 = {
    ...
    onClick: (...[$event]) => {
        ...
        // @ts-ignore
        [generateDialog, openAddDialog,];
    },
};
var __VLS_60;
var __VLS_61;
if (__VLS_ctx.AddIncomeDialog) {
    const __VLS_64 = (__VLS_ctx.AddIncomeDialog);
    // @ts-ignore
...
const __VLS_69 = IncomeEditDialog;
// @ts-ignore
const __VLS_70 = __VLS_asFunctionalComponent1(__VLS_69, new __VLS_69({
    ...{ 'onUpdated': {} },
    modelValue: (__VLS_ctx.editDialog),
    income: (__VLS_ctx.selectedIncome),
}));
...
// @ts-ignore
[load, AddIncomeDialog, AddIncomeDialog, addDialog, duplicateEntry, editDialog, selectedIncome, deleteDialog,];
var __VLS_91;
let __VLS_94;
