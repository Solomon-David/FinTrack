...
const AddExpenseDialog = shallowRef(null);
...
const filteredExpenses = computed(() => {
    ...
    return expenseStore.expenses.filter((expense) => {
        if (searchFilter.value === "Item")
            return expense.item.toLowerCase().includes(q);
        if (searchFilter.value === "Vendor")
            return expense.vendor?.name.toLowerCase().includes(q);
        if (searchFilter.value === "Amount")
            return String(expense.amount).includes(q);
...
for (const [group, date] of __VLS_vFor((__VLS_ctx.groupedExpenses))) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        key: (date),
        ...{ class: "mb-4" },
    });
    /** @type {__VLS_StyleScopedClasses['mb-4']} */ ;
    for (const [expense] of __VLS_vFor((group))) {
        const __VLS_29 = ExpenseItem;
        // @ts-ignore
        ...
        var __VLS_33;
        // @ts-ignore
        [filters, handleSearch, expenseStore, load, groupedExpenses, openEdit, openDuplicate, confirmDelete,];
    }
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
if (!__VLS_ctx.expenseStore.isLoading && __VLS_ctx.filteredExpenses.length === 0) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
var __VLS_60;
var __VLS_61;
if (__VLS_ctx.AddExpenseDialog) {
    const __VLS_64 = (__VLS_ctx.AddExpenseDialog);
    // @ts-ignore
...
const __VLS_69 = ExpenseEditDialog;
// @ts-ignore
const __VLS_70 = __VLS_asFunctionalComponent1(__VLS_69, new __VLS_69({
    ...{ 'onUpdated': {} },
    modelValue: (__VLS_ctx.editDialog),
    expense: (__VLS_ctx.selectedExpense),
}));
...
// @ts-ignore
[load, generateDialog, openAddDialog, AddExpenseDialog, AddExpenseDialog, addDialog, duplicateEntry, editDialog, selectedExpense, deleteDialog,];
var __VLS_91;
let __VLS_94;
